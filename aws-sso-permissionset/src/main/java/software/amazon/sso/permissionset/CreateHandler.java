    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(model, callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-SSO-PermissionSet::Create", proxyClient, model, callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-SSO-PermissionSet::postCreate", proxyClient, model, callbackContext)
